...
//		pageMaker.setTotalCount(service.listCountCriteria(cri));
	...
	public void modifyPagningGET(@RequestParam("bno") int bno, @ModelAttribute("cri") SearchCriteria cri, Model model) throws Exception{
		
		model.addAttribute(service.read(bno));
	}
	@RequestMapping(value="/modifyPage", method= RequestMethod.POST)
	public String modifyPagningPOST(BoardVO board, SearchCriteria cri, RedirectAttributes rttr) throws Exception{
